    ...
    "triggeringBehavior": {
        "operation": {
            ...
            "textToAnnounce": [
                {
                    "locale": "en-US",
                    "text": "Work session completed. Great job remaining focused. Keep up the hard work!"
                }
            ]
        },
        "notificationConfig": {
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        if (!permissions) {
            ...
            handlerInput.responseBuilder
                .speak("would you like to set a timer for your work session?")
                .reprompt("would you like to set a timer for your work session?")
        }
...
const ConnectionsResponsetHandler = {
    ...
    handle(handlerInput) {
        ...
        switch (status) {
            case "ACCEPTED":
                handlerInput.responseBuilder
                    .speak("Now that we have permission to set a timer. Would you like to start the work session?")
                    .reprompt('would you like to start?')
                break;
            case "DENIED":
                handlerInput.responseBuilder
                    .speak("Without permissions, I can't set a timer and start a work session. So I guess that's goodbye.");
                break;
            case "NOT_ANSWERED":
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        ...
        const speakOutput = `Sorry, I had trouble doing what you asked. Please try again to set up the session well.`;
